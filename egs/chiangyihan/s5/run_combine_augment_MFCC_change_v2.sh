...
s5_root=$(pwd)
data=$(pwd)/data/LDV_VITS_asr_16k_ldvmic_G550000/final  #change
data_root=$(pwd)/data/LDV_VITS_asr_16k_ldvmic_G550000
model_name=LDV_VITS_asr_16k_ldvmic_G550000                  #change
nj=4 #CPU 線程
