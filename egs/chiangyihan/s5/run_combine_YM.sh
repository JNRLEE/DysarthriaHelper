...
#路徑cd到S5
mfcc_conf_path=/work/jerryfat/kaldi-trunk/egs/chiangyihan/s5/data/LDV_cva_asr/conf_forfun/mfcc_hires.conf
s5_root=$(pwd)
data=$(pwd)/data/yumin_aug/final  #change
data_root=$(pwd)/data/yumin_aug
model_name=yumin_aug                  #change
nj=1 #CPU 線程
