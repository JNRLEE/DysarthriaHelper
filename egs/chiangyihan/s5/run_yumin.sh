...
#路徑cd到S5
test_data=data/yumin_LDV_outside/data/test                #change ppg
test_data2=data/yumin_LDV_outside/test/ci_iv         #change ppg
test_data3=data/yumin_LDV_outside/test/ci_iv_nopitch #change ppg
test_name=yumin_LDV_outside                            #change ppg
model_name=yumin_LDV                        #change asr model
nj=1 #CPU 線程
