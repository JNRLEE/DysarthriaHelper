...
s5_root=$(pwd)
data=$(pwd)/data/LDV_VITS_asr/final  #change
data_root=$(pwd)/data/LDV_VITS_asr
model_name=LDV_VITS_asr                  #change
nj=3 #CPU 線程
...
steps/nnet3/chain/train.py --stage $train_stage \
    ...
    --trainer.optimization.final-effective-lrate 0.00004 \
