...
model_name=cva_asr_new

subdir=data/test
test_data=data/$test_name/$subdir
test_data2=$test_data/$subdir/${test_name}_iv
test_data3=$test_data/$subdir/${test_name}_iv_nopitch
...
echo -e "####PPG"
# simple PPG
steps/nnet3/chain/get_phone_post.sh --remove-word-position-dependency true --online-ivector-dir $test_data3/ivectors $dir/nnet3/tri4_biphone_tree $dir/chain data/cva_asr/$subdir/lang $test_data3 $save_path  || exit 1
