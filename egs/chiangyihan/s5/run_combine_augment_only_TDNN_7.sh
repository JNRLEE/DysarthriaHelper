...
dir=exp_learning/cva_asr_new_aug_s7/chain 
...
bash -c "cat > $dir/configs/network.xconfig" <<EOF
  ...
  tdnnf-layer name=tdnnf2 $tdnnf_opts dim=128 bottleneck-dim=80 time-stride=7
  tdnnf-layer name=tdnnf3 $tdnnf_opts dim=128 bottleneck-dim=80 time-stride=7
  tdnnf-layer name=tdnnf4 $tdnnf_opts dim=128 bottleneck-dim=80 time-stride=7
  tdnnf-layer name=tdnnf5 $tdnnf_opts dim=128 bottleneck-dim=80 time-stride=7
  tdnnf-layer name=tdnnf6 $tdnnf_opts dim=128 bottleneck-dim=80 time-stride=7
  tdnnf-layer name=tdnnf7 $tdnnf_opts dim=128 bottleneck-dim=80 time-stride=7
  tdnnf-layer name=tdnnf8 $tdnnf_opts dim=128 bottleneck-dim=70 time-stride=7
  tdnnf-layer name=tdnnf9 $tdnnf_opts dim=128 bottleneck-dim=60 time-stride=7
  tdnnf-layer name=tdnnf10 $tdnnf_opts dim=128 bottleneck-dim=80 time-stride=7
  tdnnf-layer name=tdnnf11 $tdnnf_opts dim=128 bottleneck-dim=80 time-stride=7
  tdnnf-layer name=tdnnf12 $tdnnf_opts dim=128 bottleneck-dim=80 time-stride=7
  tdnnf-layer name=tdnnf13 $tdnnf_opts dim=128 bottleneck-dim=80 time-stride=7
  tdnnf-layer name=tdnnf14 $tdnnf_opts dim=128 bottleneck-dim=80 time-stride=7
  #tdnnf-layer name=tdnnf15 $tdnnf_opts dim=128 bottleneck-dim=80 time-stride=7
  #tdnnf-layer name=tdnnf16 $tdnnf_opts dim=128 bottleneck-dim=80 time-stride=7
