...
s5_root=$(pwd)
data=$(pwd)/data/LDV_VITS_asr_16k_synldv_synnorm_trueldv_s1org_s2org_s5org_G1000000/final  #change
data_root=$(pwd)/data/LDV_VITS_asr_16k_synldv_synnorm_trueldv_s1org_s2org_s5org_G1000000
model_name=LDV_VITS_asr_16k_synldv_synnorm_trueldv_s1org_s2org_s5org_G1000000                #change
nj=3 #CPU 線程
...
utils/subset_data_dir.sh $data_root/raw 250 $data/inside_test || exit 1 
...
steps/nnet3/chain/train.py --stage $train_stage \
    ...
    --trainer.optimization.final-effective-lrate 0.000002 \
