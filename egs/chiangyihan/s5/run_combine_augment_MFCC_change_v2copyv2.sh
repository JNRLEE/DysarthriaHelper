...
s5_root=$(pwd)
data=$(pwd)/data/LDV_VITS_asr_16k_synmic_synnorm_truemic_noise_s1org_s2org_s5org_G1000000/final  #change
data_root=$(pwd)/data/LDV_VITS_asr_16k_synmic_synnorm_truemic_noise_s1org_s2org_s5org_G1000000
model_name=LDV_VITS_asr_16k_synmic_synnorm_truemic_noise_s1org_s2org_s5org_G1000000               #change
nj=3 #CPU 線程
