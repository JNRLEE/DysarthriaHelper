...
s5_root=$(pwd)
data=$(pwd)/data/LDV_VITS_asr_16k_synldv_synreal_G1000000/final  #change
data_root=$(pwd)/data/LDV_VITS_asr_16k_synldv_synreal_G1000000
model_name=LDV_VITS_asr_16k_synldv_synreal_G1000000                  #change
nj=2 #CPU 線程
