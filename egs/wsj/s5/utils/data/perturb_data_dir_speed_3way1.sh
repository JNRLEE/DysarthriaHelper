...
# 在執行 get_utt2dur.sh 之前先確保沒有 segments 文件
rm -f ${srcdir}/segments 2>/dev/null || true
utils/data/get_utt2dur.sh --nj 4 ${srcdir}

utils/data/get_utt2dur.sh --segments false ${srcdir} 
